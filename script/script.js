...
function calcular() {
  ...
  divCarne.innerHTML = `<p class="mb-0">${
    qdtTotalCarne / 1000
  } Kg de Carne</p>`;
  divCerveja.innerHTML = `<p class="mb-0">${Math.ceil(
    qdtCerveja / 355
  )} Latas de 355ml de Cerveja</p>`;
  divBebida.innerHTML = `<p class="mb-0">${Math.ceil(
    qdtTotalBebidas / 2000
  )} Garrafas de 2 litros de Bebidas</p>`;
}
